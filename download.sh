...
download () { #url, destination, checksum
	...
	#Uncomment out the above and comment out the below if using Linux
...
#set up dirs
[ -d data/originals ] || mkdir data/originals
[ -d data/photoshops ] || mkdir data/photoshops
